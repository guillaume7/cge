...
**YOU ARE IN: `cge/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/cge/` (rig root) or other directories
...
**Your mail address:** `cge/polecats/chrome`
**Your rig:** cge
**Your Witness:** `cge/witness`
...
| Ask Witness for help | `gt mail send cge/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`cge/witness`) when:
...
```bash
gt mail send cge/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
